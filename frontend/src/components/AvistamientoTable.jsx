        ...
        <tbody>
          {avistamientos.map(av => (
            <tr key={av.id}>
              ...
              <td>{av.ubicacion}</td>
              <td>
                <span className="badge">{av.cantidad}</span>
              </td>
              <td>{av.forma || '—'}</td>
              ...
              <td>
                <button className="btn btn-sm btn-edit"   onClick={() => onEditar(av)}>
                  Editar
                </button>
                <button className="btn btn-sm btn-delete" onClick={() => onEliminar(av.id)}>
                  Eliminar
                </button>
              </td>
            </tr>
